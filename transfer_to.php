   ...
   <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	<style>
		...
		body{
			...
			background-image:url("https://www.pymnts.com/wp-content/uploads/2019/10/Coinbase-cryptocurrency-USD-Coin-rewards-crypto.jpg");
...
<body>
	...
	<center>
		<div class="view">
			<br><br><h2 style=" font-size:45px;color:red;text-shadow: 2px 2px black;">TRANSFER MONEY</h2>
				...
				<table>
					<tr>
						<td style="font-size:12pt;color:#010114;">
							...
							&nbsp; <select name="receiver" style="font-size: 12pt; height: 28px; width:190px;">
